...
public class BaseBlockUtil {
    ...
    protected int SO_TIMEOUT = 300 * 1000;       // Set data wait timeout to 5 minutes
    ...
    public SliceUploadHttpResult mkFile(Map<String, String> headMap, String key, PutExtra putExtra, int time) {
        ...
        try {
            ...
            // 401: Upload data block verification error; 412: Server block stitching file error, need to re-upload file; 500: Server failure; 579: Callback failure, no longer retry makefile;
            ...
            // Retry makefile for connection exceptions
    ...
    public HttpPost buildUpPost(String url) {
        ...
        RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(SO_TIMEOUT).setConnectTimeout(REQUEST_TIMEOUT).build();// Set request and transmission timeout
